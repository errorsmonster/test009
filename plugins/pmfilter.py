        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧', url ='https://telegram.me/Luci_request_Group')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧", url=f"https://t.me/Luci_request_Group")]])
    )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ᴘʀᴇᴍɪᴜᴍ", url=f"https://t.me/Luci_Bot_Support"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/Luci_request_Group")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        try:
            ...
            if await db.has_premium_access(user_id):                               
                buttons = [[
                    ...
                    InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url='https://t.me/LUCI_MOVIES')
                ]]
            else:
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(1966983383))
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(1966983383))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('⚜️ ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ɢᴇᴛ ꜰʀᴇᴇ ᴛʀɪᴀʟ', user_id=int(1966983383))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(1966983383))
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton ('• ᴠɪsɪᴛ ᴏᴜʀ ᴄᴏᴍᴍᴜɴɪᴛʏ •', url="t.me/Luci_request_Group"),
        ], [
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(1966983383)),
        ...
        buttons = [[
            InlineKeyboardButton('× ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ ×', url="https://t.me/Luci_Movies/73")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="t.me/Luci_request_Group"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/LUCI_MOVIES")
       ],[
            InlineKeyboardButton('• sᴇʀɪᴇsғʟɪx •', url="https://t.me/+HoaQzV_mYcdmMTY1"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇғʟɪx •', url="https://t.me/+Um7kD-Q5u8wyZTg9")
       ],[
            InlineKeyboardButton('• ᴀɴɪᴍᴇ ᴄʀᴜɪsᴇ •', url="https://t.me/+M9BMuKdhLMljZWFl")
       ],[ 
            InlineKeyboardButton('◁ ʙᴀᴄᴋ', callback_data='start')
        ]]
        await client.edit_message_media(
...
async def auto_filter(client, msg, spoll=False):
    ...
    #     ]
        ...
        btn.insert(0, [
            InlineKeyboardButton("ᴘʀᴇᴍɪᴜᴍ", url=f"https://t.me/Luci_request_Group"),
            InlineKeyboardButton("sᴇɴᴅ ᴀʟʟ", callback_data=f"sendfiles#{key}")
        ])
